...
const STEPS = [
  ...
  },
  {
    n: 2,
    title: "Design",
    desc: "Iterative creation with matrix constraints built-in from the start",
    bullets: ["Heat & pH stability", "Protein/fat systems", "Shear resistance"],
    icon: SwatchBook,
  },
  {
    n: 3,
  ...
  },
  {
    n: 4,
    title: "Scale",
    desc: "QA/QC protocols, specifications, and production documentation",
    bullets: ["Quality systems", "Production specs", "Scale-up support"],
    icon: ShieldCheck,
  },
];
      ...
      <div className="section-container">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="mt-5 section-paragraph">
            ...
            so should its flavours. Our bespoke solutions deliver exactly what
            your product requires - from taste profile to technical format.
          </motion.p>
        </motion.div>
...
export function DevelopmentProcessSection() {
  ...
  // Progress of the vertical line inside the timeline container (desktop only)
  const { scrollYProgress } = useScroll({
    target: containerRef,
  ...
  return (
    <section
      id="process"
      className="relative bg-background text-black overflow-hidden"
    >
      {/* Background accents */}
            ...
            {STEPS.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card */}
                  <div
                    className={`w-full max-w-xl mx-auto md:max-w-[520px] ${
                      isLeft
